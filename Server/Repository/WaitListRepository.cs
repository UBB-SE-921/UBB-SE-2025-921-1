...
namespace Server.Repository
{
    public class WaitListRepository : IWaitListRepository
    {
        ...
        /// <summary>
        /// Default constructor for WaitListRepository.
        /// </summary>
        /// <param name="connectionString">The database connection string. Cannot be null or empty.</param>
        /// <remarks>
        /// Initializes a new instance of the WaitListRepository class with the specified connection string
        ...
        /// <summary>
        /// Constructor for WaitListRepository with dependency injection support.
        /// </summary>
        /// <param name="connectionString">The database connection string. Cannot be null or empty.</param>
